...
';
	...
	// Register menus
	    function register_my_menus() {
		 ...
		 // Add expanding search bar to end of header-navigation menu || sauce: https://wpscholar.com/blog/append-items-to-wordpress-nav-menu/
			add_filter('wp_nav_menu_items', 'add_search_bar', 10, 2);
				function add_search_bar($items, $args){
					if( $args->theme_location == 'header-menu' ){
						$items .= '<li class="header-search-form">
						<form class="header-search-form">
							<label class="u-visually-hidden" for="s">Search</label>
